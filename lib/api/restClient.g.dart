...
class _RestClient implements RestClient {
  ...
  @override
  Future<LetterTypeResponseEntity> getletterNames() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<LetterTypeResponseEntity>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = LetterTypeResponseEntity.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<GetAllTeamResponse> GetAllTeam(employerId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'employerId': employerId};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GetAllTeamResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = GetAllTeamResponse.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<LocationResponse> GetLocations(employerId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'employerId': employerId};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/location/getlocationsbyemployerid',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<DefaultResponseEntity<String>> RegisterEmployee(
      registerRequestEntity) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(registerRequestEntity.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<DefaultResponseEntity<String>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/employee/registeremployeefromapp',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<DefaultResponseEntity<dynamic>> ForgetPassword(email) async {
    const _extra = <String, dynamic>{};
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<DefaultResponseEntity<dynamic>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = DefaultResponseEntity<dynamic>.fromJson(_result.data!);
    return value;
  }
